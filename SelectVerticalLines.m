...
function [lines] = SelectVerticalLines(H, ...
        ...
        [selTime,~] = ginput(1);                      % run ginput
    
        figure_Main.HandleVisibility = fhv;        % return original state
        ...
        VerticalLine = xline(H.Axes.Raw, selTime, '-.k', x, 'LineWidth', 2, "LabelHorizontalAlignment","center","FontSize",24, "FontWeight","bold");
